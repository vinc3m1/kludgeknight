          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <a
                ...
                className="inline-flex items-center px-4 py-2 bg-gray-900 hover:bg-gray-800 text-white rounded hover:rounded-md transition-colors"
              >
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-sm bg-red-50 text-red-600 border border-red-200 rounded hover:bg-red-100 transition-colors cursor-pointer"
                >
                  Disconnect
                </button>
              </div>
